...
class block_quickmail_event_notification_assignment_submitted_model_testcase extends advanced_testcase {
    ...
    public function test_gets_model_class_name_from_key() {
        $modelclassname = notification_model_helper::get_model_class_name('assignment_submitted');

        $this->assertEquals('assignment_submitted_model', $modelclassname);
    }

    public function test_gets_full_model_class_name_from_type_and_key() {
        $fullmodelclassname = notification_model_helper::get_full_model_class_name('event', 'assignment_submitted');

        $this->assertEquals(assignment_submitted_model::class, $fullmodelclassname);
    }
